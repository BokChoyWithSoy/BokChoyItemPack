...
namespace BokChoyItemPack.Items.Wave2
{
    public class Quel : ItemBase<Quel>
    {
        ...
        public override string ItemPickupDesc => "Every 100 kills, gain a random item.";
        ...
        public override GameObject ItemModel => MainAssets.LoadAsset<GameObject>("QuelBoxDisplay.prefab");

        public override Sprite ItemIcon => MainAssets.LoadAsset<Sprite>("Quel.png");
        ...
        {
            var ItemBodyModelPrefab = MainAssets.LoadAsset<GameObject>("QuelBoxPickup.prefab");
