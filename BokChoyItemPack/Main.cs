using BepInEx;
using BokChoyItemPack.Artifact;
...
namespace BokChoyItemPack
{
    ...
    [R2APISubmoduleDependency(nameof(ItemAPI), nameof(LanguageAPI), nameof(EliteAPI), nameof(PrefabAPI))]
    public class Main : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("BokChoyItemPack.bokchoyitempackbundle"))
            {
